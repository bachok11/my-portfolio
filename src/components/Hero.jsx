...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Spinning ring */}
      <div className="spin-slow float" style={{
      ...
      {/* Main content */}
      <div style={{
        textAlign: 'center', maxWidth: 780, position: 'relative', zIndex: 2,
        ...
        <div style={{
          ...
          marginBottom: 32, fontSize: '0.72rem',
        ...
        {/* Greeting line */}
        <div style={{ fontSize: '0.85rem', letterSpacing: 4, color: '#556', marginBottom: 12 }}>
          <span style={{ color: 'var(--neon-cyan)' }}>&gt;&gt;</span> INITIALIZING PROFILE...
        </div>
        ...
        >
          ...
          <br />
          <span style={{ color: '#fff', WebkitTextStroke: '1px rgba(0,245,255,0.3)' }}>AMIN</span>
        </h1>

        {/* Typing title */}
        <div style={{ fontSize: 'clamp(1rem, 3vw, 1.5rem)', letterSpacing: 4, marginBottom: 24, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
        ...
        <p style={{
          ...
          <span className="neon-cyan">Significs Sdn Bhd</span>.
        ...
        <div style={{
          ...
          {[
            ...
            <div key={s.label} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--neon-cyan)', fontFamily: 'Courier New' }}>{s.val}</div>
              <div style={{ fontSize: '0.7rem', letterSpacing: 2, color: '#556', textTransform: 'uppercase', marginTop: 4 }}>{s.label}</div>
            </div>
          ))}
        </div>
      </div>
