...
import { ExternalLink, GitFork, Smartphone, Globe, Cpu, Drone, Building2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 64, opacity: inView ? 1 : 0, transform: inView ? 'translateY(0)' : 'translateY(20px)', transition: 'all 0.6s ease' }}>
        <div style={{ fontSize: '0.72rem', letterSpacing: 4, color: 'var(--neon-pink)', marginBottom: 8 }}>// SECTION_03</div>
        ...
        <div style={{ height: 2, width: 80, background: 'linear-gradient(90deg, var(--neon-pink), var(--neon-purple), transparent)' }} />
      </div>
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: isHov ? `0 0 30px ${proj.color}25, 0 0 60px ${proj.color}10` : 'none',
                borderRadius: 4,
                padding: 28,
                cursor: 'pointer',
                transition: 'all 0.35s ease',
                transform: inView ? (isHov ? 'translateY(-6px)' : 'translateY(0)') : 'translateY(30px)',
                opacity: inView ? 1 : 0,
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16 }}>
                ...
                <span style={{
                  fontSize: '0.65rem', letterSpacing: 2, padding: '4px 10px',
                  borderRadius: 2,
              ...
              {/* Title */}
              <h3 style={{ color: '#dde', fontWeight: 700, fontSize: '1.05rem', marginBottom: 4, fontFamily: 'Courier New', letterSpacing: 0.5 }}>
                {proj.title}
              </h3>
              <div style={{ fontSize: '0.72rem', color: proj.color, letterSpacing: 2, marginBottom: 14, textTransform: 'uppercase' }}>
                {proj.type}
              </div>

              <p style={{ color: '#7788aa', fontSize: '0.85rem', lineHeight: 1.7, marginBottom: 20 }}>
                {proj.desc}
              </p>
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                {proj.github ? (
                  <a href={proj.github} target="_blank" rel="noopener noreferrer" style={{
                    ...
                    background: 'none', border: `1px solid ${proj.color}44`,
                    color: proj.color, padding: '6px 14px', borderRadius: 2,
                    fontSize: '0.72rem', letterSpacing: 1, cursor: 'pointer',
                  ...
                  <span style={{
                    ...
                    color: proj.color + '55', padding: '6px 14px', borderRadius: 2,
